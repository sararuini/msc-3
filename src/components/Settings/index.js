      ...
      <div>
        ...
        <ul>
          {SIGN_IN_METHODS.map((signInMethod) => {
            const onlyOneLeft = activeSignInMethods.length === 1; //onlyOneLeft prevents user from locking themselves out
            const isEnabled = activeSignInMethods.includes(signInMethod.id);

            //differentiation between active and non-active sign in methods
            return (
